...
Name: wandbox-boost-1.54.0-gcc-head
Version: 1.54.0
Release: 4
License: Boost
Group: wandbox
...
sed "s#using[ 	]*gcc.*;#using gcc : : %{_gccdir}/bin/g++ : <linkflags>-Wl,-rpath,%{_gccdir}/lib,-rpath,%{_gccdir}/lib64 <cxxflags>-std=gnu++11 <cxxflags>-Wno-unused-local-typedefs <cxxflags>-Wno-deprecated-declarations ;#" -i project-config.jam
