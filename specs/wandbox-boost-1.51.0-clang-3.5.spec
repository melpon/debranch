...
Name: wandbox-boost-1.51.0-clang-3.5
Version: 1.51.0
Release: 3
License: Boost
Group: wandbox
...
%define _prefix /opt/wandbox/boost-1.51.0-clang-3.5
...
%build
find . -maxdepth 1 -name "boost-1.51.0-clang-3.5*.patch" -print0 | xargs -0 cat | patch -p1
