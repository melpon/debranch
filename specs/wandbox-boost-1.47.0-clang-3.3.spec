...
Name: wandbox-boost-1.47.0-clang-3.3
Version: 1.47.0
Release: 1
License: Boost
Group: wandbox
...
%define _prefix /opt/wandbox/boost-1.47.0-clang-3.3
...
%build
find . -maxdepth 1 -name 'boost-1.47.0-clang-3.3*.patch' -print0 | xargs -0 cat | patch -p1
