...
Name: wandbox-boost-1.55.0-gcc-4.7.3
Version: 1.55.0
Release: 1
License: Boost
Group: wandbox
...
%define _prefix /opt/wandbox/boost-1.55.0-gcc-4.7.3
...
%build
cp %{SOURCE1} %{SOURCE2} .
find . -maxdepth 1 -name 'boost-1.55.0-gcc-4.7.3*.patch' -print0 | xargs -0 cat | patch -p1
