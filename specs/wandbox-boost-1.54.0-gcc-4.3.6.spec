...
Name: wandbox-boost-1.54.0-gcc-4.3.6
Version: 1.54.0
Release: 1
License: Boost
Group: wandbox
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-buildroot
BuildRequires: wandbox-gcc-4.3.6 libbz2-dev python-dev
...
%define _prefix /opt/wandbox/boost-1.54.0-gcc-4.3.6
%define _gccdir /opt/wandbox/gcc-4.3.6
...
find . -maxdepth 1 -name 'boost-1.54.0-gcc-4.3.6*.patch' -print0 | xargs -0 cat | patch -p1
