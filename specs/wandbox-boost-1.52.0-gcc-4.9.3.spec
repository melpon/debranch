...
Name: wandbox-boost-1.52.0-gcc-4.9.3
Version: 1.52.0
Release: 4
License: Boost
Group: wandbox
...
BuildRequires: wandbox-gcc-4.9.3 libbz2-dev
Source0: http://downloads.sourceforge.net/project/boost/boost/1.52.0/boost_1_52_0.tar.gz
URL: http://melpon.org/wandbox

%define _prefix /opt/wandbox/boost-1.52.0-gcc-4.9.3
%define _gccdir /opt/wandbox/gcc-4.9.3
