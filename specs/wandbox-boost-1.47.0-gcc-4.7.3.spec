...
Name: wandbox-boost-1.47.0-gcc-4.7.3
Version: 1.47.0
Release: 2
License: Boost
Group: wandbox
...
BuildRequires: wandbox-gcc-4.7.3 libbz2-dev python-dev
...
%define _prefix /opt/wandbox/boost-1.47.0-gcc-4.7.3
...
find . -maxdepth 1 -name "boost-1.47.0-gcc-4.7.3*.patch" -print0 | xargs -0 cat | patch -p1
