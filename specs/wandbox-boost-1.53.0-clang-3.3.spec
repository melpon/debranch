...
Name: wandbox-boost-1.53.0-clang-3.3
Version: 1.53.0
Release: 3
License: Boost
Group: wandbox
...
BuildRequires: wandbox-clang-3.3 libbz2-dev python-dev
Source0: http://downloads.sourceforge.net/project/boost/boost/1.53.0/boost_1_53_0.tar.gz
URL: http://melpon.org/wandbox

%define _prefix /opt/wandbox/boost-1.53.0-clang-3.3
%define _clangdir /opt/wandbox/llvm-3.3
...
%build
find . -maxdepth 1 -name "boost-1.53.0-clang-3.3*.patch" -print0 | xargs -0 cat | patch -p1
