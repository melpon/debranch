...
Name: wandbox-boost-1.47.0-gcc-4.3.6
Version: 1.47.0
Release: 1
License: Boost
Group: wandbox
...
%define _prefix /opt/wandbox/boost-1.47.0-gcc-4.3.6
...
find . -maxdepth 1 -name 'boost-1.47.0-gcc-4.3.6*.patch' -print0 | xargs -0 cat | patch -p1
