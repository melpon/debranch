...
Name: wandbox-boost-1.54.0-gcc-4.9.0
Version: 1.54.0
Release: 4
License: Boost
Group: wandbox
...
BuildRequires: wandbox-gcc-4.9.0 libbz2-dev
Source0: http://downloads.sourceforge.net/project/boost/boost/1.54.0/boost_1_54_0.tar.gz
URL: http://melpon.org/wandbox

%define _prefix /opt/wandbox/boost-1.54.0-gcc-4.9.0
%define _gccdir /opt/wandbox/gcc-4.9.0
