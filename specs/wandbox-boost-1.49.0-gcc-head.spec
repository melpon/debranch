...
Name: wandbox-boost-1.49.0-gcc-head
Version: 1.49.0
Release: 1
License: Boost
Group: wandbox
...
%define _prefix /opt/wandbox/boost-1.49.0-gcc-head
...
find . -maxdepth 1 -name 'boost-1.49.0-gcc-head*.patch' -print0 | xargs -0 cat | patch -p1
