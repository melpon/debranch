...
%prep
%setup -q -c -T
svn co -q 'https://llvm.org/svn/llvm-project/llvm/trunk' source
svn co -q 'https://llvm.org/svn/llvm-project/cfe/trunk' source/tools/clang
svn co -q 'https://llvm.org/svn/llvm-project/compiler-rt/trunk' source/projects/compiler-rt
svn co -q 'https://llvm.org/svn/llvm-project/clang-tools-extra/trunk' source/tools/clang/tools/extra
svn co -q 'https://llvm.org/svn/llvm-project/libcxx/trunk' libcxx
