...
Name: wandbox-boost-1.53.0-clang-3.2
Version: 1.53.0
Release: 3
License: Boost
Group: wandbox
...
%define _prefix /opt/wandbox/boost-1.53.0-clang-3.2
...
%build
find . -maxdepth 1 -name "boost-1.53.0-clang-3.2*.patch" -print0 | xargs -0 cat | patch -p1
