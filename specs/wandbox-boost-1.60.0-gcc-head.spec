...
Name: wandbox-boost-1.60.0-gcc-head
Version: 1.60.0
Release: 4
License: Boost
Group: wandbox
...
Source0: http://downloads.sourceforge.net/project/boost/boost/1.60.0/boost_1_60_0.tar.gz
URL: http://melpon.org/wandbox

%define _prefix /opt/wandbox/boost-1.60.0-gcc-head
...
ln -s %{_prefix}/../boost-headers-1.60.0/boost %{buildroot}%{_prefix}/include/boost
